...
<template>
	<v-card>
		<v-card-title class="pb-0">
			<v-icon small class="mr-1">mdi-cube-scan</v-icon> {{ t('panel.threedscanner.caption') }}
		</v-card-title>
