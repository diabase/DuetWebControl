...
<template>
	<div>
		...
		<file-edit-dialog :shown.sync="editDialog.shown" :filename="editDialog.filename" v-model="editDialog.content" @editComplete="$emit('file-edited', $event)"></file-edit-dialog>
